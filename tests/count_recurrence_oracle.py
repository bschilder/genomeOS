...
def absolute_law(n: int, p: float, c: float, counts: tuple[int, ...], precision: int) -> Oracle:
...
def verified_law(n: int, p: float, c: float, counts: tuple[int, ...]) -> Oracle:
    first = absolute_law(n, p, c, counts, 400)
    second = absolute_law(n, p, c, counts, 480)
