...
| `scripts/reference_window_io.py` | Bounded network/file adapters and sparse/header/original-record acquisition. |
...
| `scripts/reference_window_artifacts.py` | Exclusive manifest writers and acquisition artifact validation. |
