...
| `scripts/reference_window_io.py`, `scripts/reference_window_fetch.py`, `scripts/reference_window_read.py` | 4: stable adapter facade, bounded body transfer, sparse coverage and raw/native readers. |
...
| `scripts/reference_window_artifacts.py` | 5: stable artifact facade. |
| `scripts/reference_artifact_run_validation.py`, `scripts/reference_acquisition_artifacts.py`, `scripts/reference_preparation_artifacts.py` | 5: run-receipt validation and phase-specific exclusive manifest writers/read-back validation. |
...
| `scripts/reference_native_stage.py`, `scripts/reference_count_execution.py`, `scripts/reference_preparation_outputs.py` | 6: native stage orchestration, one-pass paired-cohort counting and preparation fragment/ledger emission. |
